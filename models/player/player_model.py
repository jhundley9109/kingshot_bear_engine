class PlayerModel:
    def __init__(self, player_id=None, canonical_name=None, created_at=None, updated_at=None, event_count=0, guild_id=None):
    ...
    def get_guild_id(self): return self._guild_id
    ...
    def set_guild_id(self, value): self._guild_id = value
